                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div>
                        <label className="block text-xs font-semibold text-slate-400 mb-2 uppercase" style={{ letterSpacing: '0.08em' }}>{t('name')}</label>
                      ...
                      <div>
                        <label className="block text-xs font-semibold text-slate-400 mb-2 uppercase" style={{ letterSpacing: '0.08em' }}>{t('phone')}</label>
                    ...
                    <div>
                      <label className="block text-xs font-semibold text-slate-400 mb-2 uppercase" style={{ letterSpacing: '0.08em' }}>{t('service')}</label>
                      <div className="relative">
                        ...
                        <div className="absolute inset-y-0 start-4 flex items-center pointer-events-none text-slate-400 text-xs">▾</div>
                      </div>
                    </div>

                    <div>
                      <label className="block text-xs font-semibold text-slate-400 mb-2 uppercase" style={{ letterSpacing: '0.08em' }}>{t('notes')}</label>
