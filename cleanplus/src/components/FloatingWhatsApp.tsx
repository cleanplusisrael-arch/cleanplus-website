export default function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed bottom-6 end-6 z-50 bg-[#25D366] hover:bg-[#1EBE5D] text-white p-4 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 group"
      aria-label="WhatsApp"
    >
